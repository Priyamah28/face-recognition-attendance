...
class Student:
    def __init__(self,root):
        ...
        main_frame=Frame(self.bg_label,bd=2)
        main_frame.place(x=10,y=55,width=1505,height=600)

        #left label frame
        left_frame=LabelFrame(main_frame,bd=2,relief=RIDGE,text="Student Details",bg="light blue",font=("Helvetica", 15, "bold"))
        ...
        #current cousre
        current__course_frame=LabelFrame(left_frame,bd=2,relief=RIDGE,text="Current course information",font=("Helvetica", 15, "bold"))
        current__course_frame.place(x=5,y=135,width=720,height=120)

        #department
        department_label=Label(current__course_frame,text="Department",font=("Helvetica", 12, "bold"))
        department_label.grid(row=0,column=0,padx=10,sticky=W)

        department_combo=ttk.Combobox(current__course_frame,textvariable=self.var_dep,font=("Helvetica", 12, "bold"),state="readonly")
        department_combo["values"]=("Select Department","Computer","IT","Civil","Mechnical")
        department_combo.current(0)
        department_combo.grid(row=0,column=1,padx=2,pady=10,sticky=W)

        #course
        course_label=Label(current__course_frame,text="Course",font=("Helvetica", 12, "bold"))
        course_label.grid(row=0,column=2,padx=10,sticky=W)

        course_combo=ttk.Combobox(current__course_frame,textvariable=self.var_course,font=("Helvetica", 12, "bold"),width=20,state="readonly")
        course_combo["values"]=("Select Course","FE","SE","TE","BE")
        course_combo.current(0)
        course_combo.grid(row=0,column=3,padx=2,pady=10,sticky=W)

         #year
        year_label=Label(current__course_frame,text="Year",font=("Helvetica", 12, "bold"))
        year_label.grid(row=1,column=0,padx=10,sticky=W)

        year_combo=ttk.Combobox(current__course_frame,textvariable=self.var_year,font=("Helvetica", 12, "bold"),state="readonly")
        year_combo["values"]=("Select Year","2020-21","2021-22","2022-23","2023-24")
        year_combo.current(0)
        year_combo.grid(row=1,column=1,padx=2,pady=10,sticky=W)

        #semester
        sem_label=Label(current__course_frame,text="Semester",font=("Helvetica", 12, "bold"))
        sem_label.grid(row=1,column=2,padx=10,sticky=W)

        sem_combo=ttk.Combobox(current__course_frame,textvariable=self.var_semester,font=("Helvetica", 12, "bold"),width=20,state="readonly")
        ...
        class_student_frame=LabelFrame(left_frame,bd=2,relief=RIDGE,text="Class Student information",font=("Helvetica", 15, "bold"))
        class_student_frame.place(x=5,y=260,width=720,height=330)

        #id
        student_id=Label(class_student_frame,text="Student ID:",font=("Helvetica", 12, "bold"))
        ...
        #name
        student_name=Label(class_student_frame,text="Student Name:",font=("Helvetica", 12, "bold"))
        ...
        #studentname_entry=ttk.Entry(class_student_frame,textvariable=self.var_div,width=20,font=("Helvetica", 12, "bold"))
       # studentname_entry.grid(row=1,column=1,padx=10,pady=5,sticky=W)
        ...
        #roll number
        roll_no_label=Label(class_student_frame,text="Roll Number:",font=("Helvetica", 12, "bold"))
        ...
        #gender_entry=ttk.Entry(class_student_frame,textvariable=self.var_gender,width=20,font=("Helvetica", 12, "bold"))
        ...
        #phone no.
        phone_no_label=Label(class_student_frame,text="Phone Number:",font=("Helvetica", 12, "bold"))
        ...
        #teacher_name
        teacher_name_label=Label(class_student_frame,text="Teacher Name:",font=("Helvetica", 12, "bold"))
        teacher_name_label.grid(row=4,column=2,padx=10,pady=5,sticky=W)

        teacher_name_entry=ttk.Entry(class_student_frame,textvariable=self.var_teacher,width=20,font=("Helvetica", 12, "bold"))
        ...
        save_btn=Button(button_frame,text="Save",command=self.add_data,width=17,font=("Helvetica", 12, "bold"),bg="Light blue",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(button_frame,text="Upadte",command=self.update_data,width=17,font=("Helvetica", 12, "bold"),bg="Light blue",fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(button_frame,text="Delete",command=self.delete_data,width=17,font=("Helvetica", 12, "bold"),bg="Light blue",fg="white")
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(button_frame,text="Reset",command=self.reset_data,width=17,font=("Helvetica", 12, "bold"),bg="Light blue",fg="white")
        ...
        take_photo_sample_btn=Button(button_frame1,command=self.generate_dataset,text="Take photo sample",width=35,font=("Helvetica", 12, "bold"),bg="Light blue",fg="white")
        take_photo_sample_btn.grid(row=1,column=0)
        
        update_photo_sample_btn=Button(button_frame1,text="Update photo sample",width=35,font=("Helvetica", 12, "bold"),bg="Light blue",fg="white")
        update_photo_sample_btn.grid(row=1,column=1)


         #right label frame
        right_frame=LabelFrame(main_frame,bd=2,relief=RIDGE,text="Student Details",bg="light blue",font=("Helvetica", 15, "bold"))
        right_frame.place(x=750,y=10,width=730,height=580)

        img_right=Image.open(r"C:\Users\mahes\OneDrive\Desktop\project 1\college_images\gettyimages-1022573162.jpg")
        ...
        #search system
        search_frame=LabelFrame(right_frame,bd=2,relief=RIDGE,text="Search System",font=("Helvetica", 15, "bold"))
        ...
        search_combo=ttk.Combobox(search_frame,font=("Helvetica", 12, "bold"),width=15,state="readonly")
        search_combo["values"]=("Select ","Roll No","Phone No","TE","BE")
        ...
        search_btn=Button(search_frame,text="Search",width=12,font=("Helvetica", 12, "bold"),bg="green",fg="white")
        search_btn.grid(row=0,column=3,padx=4)

        showall_btn=Button(search_frame,text="Show All",width=12,font=("Helvetica", 12, "bold"),bg="green",fg="white")
        ...
        self.student_table=ttk.Treeview(table_frame,columns=("dep","course","year","sem","id","name","div","gender","roll","dob","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.student_table.heading("address",text="Adrress")
        self.student_table.heading("teacher",text="DepaTeacherrment")
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="1234",database="face_recognisation")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update students set Dep=%s,Course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(self.var_dep.get(),
                                                                                                                                                                                                                                        self.var_course.get(),
                                                                                                                                                                                                                                        self.var_year.get(),
                                                                                                                                                                                                                                        self.var_semester.get(),   
                                                                                                                                                                                                                                        self.var_std_name.get(),
